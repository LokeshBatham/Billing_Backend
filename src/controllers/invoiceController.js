...
exports.list = async (req, res) => res.status(501).json({ error: 'Not implemented' });
exports.getById = async (req, res) => res.status(501).json({ error: 'Not implemented' });
exports.update = async (req, res) => res.status(501).json({ error: 'Not implemented' });
exports.remove = async (req, res) => res.status(501).json({ error: 'Not implemented' });